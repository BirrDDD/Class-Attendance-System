<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all-class.aspx.cs" Inherits="Final_project.all_class" %>
                       ...
                       <div class="new-added-form">
                           ...
                           <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input runat="server" id="studname" type="text" placeholder="" class="form-control"/>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Student Roll *</label>
                                    <input runat="server" id="studroll" type="text" placeholder="" class="form-control"/>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Department *</label>
                                    <input runat="server" id="studdept" type="text" placeholder="" class="form-control"/>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Email *</label>
                                    <input runat="server" id="studemail" type="email" placeholder="" class="form-control"/>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Phone Number *</label>
                                    <input runat="server" id="studnumber" type="number" placeholder="" class="form-control"/>
                                </div>
                           ...
                           <div class="col-xl-3 col-lg-6 col-12 form-group">
                               <div class="row">
                                   ...
                                   <asp:LinkButton ID="addstudent" OnClick="addstudent_Click" CssClass="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" Text="Add New Student" runat="server" />
                               ...
                               <%--   Added Success alrert bos --%>
                                   ...
                                   <div class="icon-color-alart"> 
                                      ...
                                      <div class="alert icon-alart bg-light-green2" role="alert">
                                          ...
                                          <asp:Label ID="alertforstud" Text="You successfully added a new student." runat="server" />  
                                    </div>
                                       </div>
                                   </span>
                                   ...
                                   <div class="alert icon-alart bg-pink2" role="alert">
                                    <i class="fas fa-times bg-pink3"></i>
                                       <asp:Label  Text="Roll or Email already exists !" runat="server" /> 
                                </div>
                                           </div>
                                       </span>
