<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="class-routine.aspx.cs" Inherits="Final_project.class_routine" %>
...
<body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="new-added-form">
                                    <div class="row">
                                        ...
                                        <div class="ui-btn-wrap col-12 form-group mg-t-8">
                                            <asp:Button ID="coursefinder" OnClick="coursefinder_Click" Text="Find Class Time" CssClass="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" runat="server"  />
                                            <asp:LinkButton  ID="coursedel" OnClick="coursedel_Click" CssClass="btn-fill-xl radius-30 text-light shadow-orange-red bg-orange-red"  runat="server" OnClientClick="return confirmSubmit();" >Delete Course<span class="fas fa-exclamation-circle mg-l-10"></span>
                                           </asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="js/main.js"></script>
            ...
            function confirmSubmit() {
                ...
                var result = confirm("Are you sure you want Delete the Course?");

                // If the user clicks "OK," the form submission proceeds; otherwise, it's canceled.
                return result;
            }
            </script>
